...
ggplot(exp_fire_fit_aug, aes(x = .fitted, y = .resid)) +
  geom_point() +
...
```{r}
exp_fire_fit_aug <- bind_cols(exp_fire_fit_aug, wildfire_clean |> select(latitude, longitude))

# Get U.S. mainland map
us_map <- map_data("state")

# Plot residuals spatially (filter to mainland)
ggplot() +
  geom_polygon(
    data = us_map,

...
fire_pre_linear_fit <- lm(fire_size ~ region + cause_category + remoteness + Vegetation_group + 
                   Wind_pre_15 + Temp_pre_15 + Hum_pre_15, data = wildfire_clean)

fire_linear_fit <- lm(log(fire_size) ~ region + cause_category + remoteness + Vegetation_group * Prec_pre_15 + 
                   Wind_pre_15 + Temp_pre_15 + Hum_pre_15, data = wildfire_clean)
...
fire_linear_fit_adjusted <- lm(log(fire_size) ~ region + cause_category + remoteness + 
                               Vegetation_group * Prec_pre_15 + Wind_pre_15 + Temp_pre_15 + Hum_pre_15, 
                               data = wildfire_clean)
...
fire_log_fit <- glm(mid50_hi ~ region + Temp_pre_30 + remoteness + Vegetation_group +
...
fire_linear_fit_aug <- augment(fire_linear_fit_adjusted)

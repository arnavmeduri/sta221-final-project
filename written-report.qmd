---
title: "Investigating Factors Associated with Wildfire Burn Area in the United States"
...
ggplot(wildfire_clean, aes(x = fire_size)) +
  ...
  labs(
    title = "Distribution of Burned Area of Wildfires", 
    x = "Burned Area (acres)",
    y = "Frequency"
  ) +
  theme_minimal()
...
ggplot(wildfire_clean, aes(x = Temp_pre_15)) +
  geom_histogram(fill = "cadetblue4", color = "white", alpha = 0.8) +
  labs(
...
ggplot(wildfire_clean, aes(x = Hum_pre_15)) +
  geom_histogram(fill = "cadetblue4", color = "white", alpha = 0.8) +
  labs(
...
```{r}
#| label: remoteness-dist
#| echo: false
#| warning: false

ggplot(wildfire_clean, aes(x = remoteness)) +
  geom_histogram(fill = "cadetblue4", color = "white", alpha = 0.8) +
  labs(
...
ggplot(data = wildfire_clean, aes(x = cause_category, y = fire_size, color = cause_category)) +
  geom_boxplot(fill = NA) +
  scale_color_manual(
    values = colorRampPalette(c("#8FBC8F", "cadetblue4"))(
      length(unique(wildfire_clean$cause_category))
    )
  ) +
  labs(
    title = "Distribution of Burned Area of Wildfires by Cause Category",
    x = "",
    y = "Burned Area (acres)",
...
ggplot(data = wildfire_clean, 
       aes(x = season, y = fire_size, color = season)) +
  geom_boxplot(fill = NA) +
  scale_color_manual(
    values = colorRampPalette(c("#8FBC8F", "cadetblue4"))(
      length(unique(wildfire_clean$season))
    )
  ) +
  labs(
    title = "Distribution of Burned Area of Wildfires by Season",
    subtitle = "Burned area (in acres) across seasons of fire discovery",
    x = "Season",
    y = "Burned Area (acres)",
    color = "Season"
  ) +
...
```{r}
#| label: vegetation-dist
#| echo: false
#| warning: false

ggplot(data = wildfire_clean, 
       aes(x = Vegetation_group, y = fire_size, color = Vegetation_group)) +
  geom_boxplot(fill = NA) +
  scale_color_manual(
    values = colorRampPalette(c("#8FBC8F", "cadetblue4"))(
      length(unique(wildfire_clean$Vegetation_group))
    )
  ) +
  labs(
    title = "Distribution of Burned Area of Wildfires by Vegetation Group",
    subtitle = "Burned area (in acres) across dominant vegetation categories",
    x = "Vegetation Group",
    y = "Burned Area (acres)",
...
```{r}
ggplot(data = wildfire_clean, 
       aes(x = region, y = fire_size, color = region)) +
  geom_boxplot(fill = NA) +
  scale_color_manual(
    values = colorRampPalette(c("#8FBC8F", "cadetblue4"))(
      length(unique(wildfire_clean$region))
    )
  ) +
  labs(
    title = "Distribution of Burned Area of Wildfires by Region",
    subtitle = "Burned area (in acres) across geographic regions",
    x = "Region",
    y = "Burned Area (acres)",
    color = "Region"
  ) +
...
ggplot(
  data = wildfire_clean,
  aes(x = factor(Prec_pre_15, levels = c(0, 1), labels = c("No Precipitation", "Precipitation")),
      y = fire_size,
      color = factor(Prec_pre_15, levels = c(0, 1), labels = c("No Precipitation", "Precipitation")))
) +
  geom_boxplot(fill = NA) +
  scale_color_manual(values = vegetation_palette[1:2]) +
  labs(
    title = "Wildfire Burned Area by 15-Day Precipitation Status",
    subtitle = "Burned area (in acres) grouped by precipitation presence 15 days prior to fire discovery",
    x = "Precipitation 15 Days Before Discovery",
    y = "Burned Area (acres)",
    color = "Precipitation"
  ) +
  theme_minimal()
...
summary(wildfire_clean$Prec_pre_15)
ggplot(wildfire_clean, aes(x = Prec_pre_15)) +
...
ggplot(wildfire_clean, aes(x = Prec_pre_15, y = log(fire_size), color = Vegetation)) +
  geom_point() +
...
exp_fire_fit <- lm(fire_size ~ region + cause_category + remoteness + 
                     Vegetation_group + Wind_pre_30 + Prec_pre_30 + 
                     Temp_pre_30 + Hum_pre_30, data = wildfire_clean)

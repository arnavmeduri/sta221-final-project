...
wildfire_clean |>
  group_by(Vegetation_group, Precipitation) |>
  summarise(
    count = n(),
  ...
  arrange(Vegetation_group, Precipitation)
```
...
# Wind
ggplot(exp_fire_fit_aug, aes(x = Wind_pre_30, y = .resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
...
# Temperature
ggplot(exp_fire_fit_aug, aes(x = Temp_pre_30, y = .resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
...
# Humidity
ggplot(exp_fire_fit_aug, aes(x = Hum_pre_30, y = .resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
...
# Precipitation
ggplot(exp_fire_fit_aug, aes(x = factor(Prec_pre_30), y = .resid)) +
  geom_boxplot() +
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  labs(
